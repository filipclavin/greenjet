...
const Seats = () => {
    ...
    const { seats, setSeats, passengers, random } = useContext(Context)

    const navigate = useNavigate()

    //TODO: PUT SEAT RENDERERS INTO USEEFFECT


    useEffect(() => {
        //start of business class
        const getBusinessRow = (max, rowNum) => {
            const businessSeatLetters = ['A', 'B', '', 'C', 'D']
            const businessRow = []
            let rand

            for (let i = 0; i < 5; i++) {
                rand = max ? Math.random() * (max - 0) : 1
                ...
                businessRow.push(
                    ...
                    >
                        <Rect
                            ...
                            fillLinearGradientColorStops={rand < 0.5 ? [0, "#5CD6C0", 1, "#22C3A6"] : [0, "#E9E8FC", 1, "#E9E8FC"]}
        ...
        for (let i = 0; i < 5; i++) {
            businessSection.push(
                <Group
                    ...
                    height={21.76}
                    key={'business-row ' + i}>
                    {getBusinessRow(random ? random[i] : null, (i + 1))}
        ...
        setBusinessClass(businessSection)
        //end of business class

        //start of economy class
        const getEconomyRow = (max, rowNum) => {
                ...
                economyRow.push(
                    ...
                    >
                        <Rect
                            ...
                            fillLinearGradientColorStops={rand < 0.5 ? [0, "#605DEC", 1, "#2A26D9"] : [0, "#E9E8FC", 1, "#E9E8FC"]}
        ...
        for (let i = 0; i < 8; i++) {
            economyFirstSection.push(
                <Group
                    ...
                    height={18.13}
                    key={'economy-1-row ' + i}>
                    {getEconomyRow(random ? random[i] : null, (i + 5))}
        ...
        for (let i = 0; i < 5; i++) {
            economySecondSection.push(
                <Group
                    ...
                    height={18.13}
                    key={'economy-2-row ' + i}>
                    {getEconomyRow(random ? random[i] : null, (i + 14))}
        ...
        for (let i = 0; i < 10; i++) {
            economyThirdSection.push(
                <Group
                    ...
                    height={18.13}
                    key={'economy-3-row ' + i}>
                    {getEconomyRow(random ? random[i] : null, (i + 19))}
        ...
        for (let i = 0; i < 5; i++) {
            economyFourthSection.push(
                <Group
                    ...
                    height={18.13}
                    key={'economy-4-row ' + i}>
                    {getEconomyRow(random ? random[i] : null, (i + 29))}
            ...
            <StyledMain>
                ...
                <Stage
                    ...
                    <Layer>
                        ...
                        <Group
                            ...
                            <Group
                                y={3.63}>
                                {economyClass && economyClass.economyFirstSection}
                            </Group>
                            <Group
                                y={170.63}>
                                {economyClass && economyClass.economySecondSection}
                            </Group>
                            <Group
                                y={282.82}>
                                {economyClass && economyClass.economyThirdSection}
                            </Group>
                            <Group
                                y={492.21}>
                                {economyClass && economyClass.economyFourthSection}
                            </Group>
                        </Group>
                    </Layer>
                </Stage>
                {
                    seats.length >= passengers.length ?
                        <NextButton onClick={() => navigate('/compensate')}>Nästa</NextButton>
                        :
                        <NextButton disabled>{seats.length + 1} / {passengers.length}</NextButton>
                }
            </StyledMain>
        </Wrapper >
    )
